...
export const COMMUNITY_CARDS: GameCard[] = [
  ...
  { id: "co03", group: "community", text: "Gastos médicos. Paga $50.", action: "pay", amount: 50 },
  { id: "co04", group: "community", text: "Gastos del médico. Paga $100.", action: "pay", amount: 100 },
  ...
  { id: "co12", group: "community", text: "Es tu cumpleaños. Cobra $10 de cada jugador.", action: "collect", amount: 10 },
  { id: "co13", group: "community", text: "Seguro de vida vence. Cobra $100.", action: "collect", amount: 100 },
  { id: "co14", group: "community", text: "Paga $50 por hospitalización.", action: "pay", amount: 50 },
  { id: "co15", group: "community", text: "Paga $150 por multa de tráfico.", action: "pay", amount: 150 },
...
export function resolveCardText(card: GameCard): string {
  if (card.text.includes("{tileName}") && card.tileIndex !== undefined) {
    return card.text.replace("{tileName}", BOARD_TILES[card.tileIndex]?.name ?? `casilla ${card.tileIndex}`);
  }
  return card.text;
}
